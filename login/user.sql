...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3354951714ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=contacts&table=info">`contacts`.`info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=user&table=user">`user`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=new_login&table=user_tbl">`new_login`.`user_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bikes&table=info">`bikes`.`info`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5a486c7d506d5b64274172683924552c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="contacts" targettable="info">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `info`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="contacts" targettable="info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `info`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bikes" targettable="info">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `bikes`.`info` ( `NAME` INT NOT NULL ,  `NUMBER` INT NOT NULL ,  `STATE` INT NOT NULL ,  `QUESTION` INT NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bikes" targettable="info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `info`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="new_login" targettable="user_tbl">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_tbl`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="user" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user` WHERE (`user`.`id` = 1) OR (`user`.`id` = 2) OR (`user`.`id` = 3) OR (`user`.`id` = 4)   </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="user" targettable="user">
                            <div class="action_content">
